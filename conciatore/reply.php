                        ...
                        <tbody>
                            <tr>
                                ...
                                <td class="title"><select name="bTitle" id="bTitle">
                                                      <option value="ㅊ답변입니다~">답변입니다~</option>
                                                    </select></td>
                            </tr>
                            <tr>
                                <td colspan="2" class="content"><textarea name="bContent" id="bContent" >[ Original Message ]<?php
                                echo "\n".$content."\n\n";
                                echo '------------------------------------------------------'?></textarea></td>
                            </tr>
                            <tr>
