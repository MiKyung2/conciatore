    ...
    <body>
		...
		<section id="content">
            <div id="jo_wrap" class="clear">
                <h2>JOIN</h2>
                <div id="join_wrap">
                    <form id="joinform" method="post" action="member_insert.php">
                        <dl>
                            <dt class="agree"><label>이용 약관 동의</label></dt>
                            <dd>
                                <textarea>제1조(목적)
이 약관은 (전자상거래 사업자)가 운영하는 conciatore(이하 “몰”이라 한다)에서 제공하는 인터넷 관련 서비스(이하 “서비스”라 한다)를 이용함에 있어 사이버 몰과 이용자의 권리․의무 및 책임사항을 규정함을 목적으로 합니다.
※「PC통신, 무선 등을 이용하는 전자상거래에 대해서도 그 성질에 반하지 않는 한 이 약관을 준용합니다.」
제2조(정의)
① “몰”이란 conciatore가 재화 또는 용역(이하 “재화 등”이라 함)을 이용자에게 제공하기 위하여 컴퓨터 등 정보통신설비를 이용하여 재화 등을 거래할 수 있도록 설정한 가상의 영업장을 말하며, 아울러 사이버몰을 운영하는 사업자의 의미로도 사용합니다.
...
부 칙(시행일) 이 약관은 년 월 일부터 시행합니다.</textarea>
                                ...
                                <label class="btn btn-primary active" for="agree">동의함</label>
                            </dd><br>
                            <dt class="agree"><label>개인정보 수집 및 이용 동의</label></dt>
                            <dd>
                                <textarea>** 본 양식은 쇼핑몰 운영에 도움을 드리고자 샘플로 제공되는 서식으로 쇼핑몰 운영형태에 따른 수정이 필요합니다. 쇼핑몰에 적용하시기 전, 쇼핑몰 운영 사항 등을 확인하시고 적절한 내용을 반영하여 사용하시기 바랍니다. **
1. 개인정보 수집목적 및 이용목적
...
※ 동의를 거부할 수 있으나 거부시 회원 가입이 불가능합니다.</textarea>
                                ...
                                <label class="btn btn-primary active" for="agree2">동의함</label>
                            </dd><br>
                            
                            <dt><label for="id">* 아이디</label></dt>
                            <dd><input type="text" id="id" name="id" placeholder="5~20자의 영문 소문자, 숫자와 특수기호(_)만 사용 가능합니다." maxlength="20"><br><p class="detail"></p></dd><br>
                            
                            <dt><label for="password">* 비밀번호</label></dt>
                            <dd><input type="password" id="password" name="excludeHangul" placeholder="영문,숫자,특수문자 혼합하여 8자리~20자리 이내" maxlength="30"><br><p class="detail"></p></dd><br>
                            <dt><label for="passwordCheck">* 비밀번호 확인</label></dt>
                            <dd><input type="password" id="passwordCheck" data-rule-required="true" placeholder="비밀번호 확인" maxlength="30"><br><p class="detail"></p></dd><br>
                            <dt><label for="name">* 이름</label></dt>
                            <dd><input type="text" class="onlyHangul" id="name" name="name" placeholder="한글만 입력 가능합니다." maxlength="15"><br><p class="detail"></p></dd><br>
                            <dt><label for="email" class="control-label">* 이메일</label></dt>
                            <dd><input type="email" id="email" name="email" placeholder="이메일" maxlength="40">
<!--                                <button>인증번호 받기<i class="fa fa-edit spaceLeft"></i></button>-->
                                <br><p class="detail"></p></dd><br>
<!--
...
-->
                            ...
                            <dd><input type="tel" id="phone"  name="phone" placeholder="- 없이 입력해 주세요"><br><p class="detail"></p></dd><br>
                            <dt><label for="sample4_postcode" >주소</label></dt>
                            <dd><input type="text" id="sample4_postcode" name="sample4_postcode" placeholder="우편번호">
                                ...
                                <input type="text" id="sample4_jibunAddress" name="sample4_jibunAddress" placeholder="상세주소"><br><p class="detail"></p>
                                <span id="guide" style="color:#999"></span></dd>
                            <br>
                        </dl>
                        
                        <div>
                            <input type="button" id="join" class="color" value="회원가입" >
